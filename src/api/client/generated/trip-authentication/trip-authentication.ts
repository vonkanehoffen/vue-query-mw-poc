 ...
 */
export const postClientVehicleRegistrationValidate = (
  vehicleRegistrationLookupRequestDtoKawfefy: MaybeRef<VehicleRegistrationLookupRequestDtoKawfefy>
) => {
  return customInstance<VehicleRegistrationLookupResponseDtoJtjgea>({
    url: `/client/vehicle-registration/validate`,
    method: 'post',
 ...
 * @summary Validate vehicle registration mark
 */
export const usePostClientVehicleRegistrationValidate = <
  TError = UnauthorizedResultPecray | ValidationExceptionResponseBaseDtoVtrnlzi,
  TContext = unknown
>(options?: {
  mutation?: UseMutationOptions<
